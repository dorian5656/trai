...
## 1. 环境准备
- **环境**: Py `3.10.14`; Conda `trai_31014_whf_trai_pro_20260202`; Pip清华源.
- **命令**: `conda create -n trai_31014_whf_trai_pro_20260202 python=3.10.14 -y && conda activate trai_31014_whf_trai_pro_20260202`
...
- **运行 (必须分步执行)**: 
  1. **激活环境**: `conda activate trai_31014_whf_trai_pro_20260202` (严禁使用 `conda run` 混合命令)
