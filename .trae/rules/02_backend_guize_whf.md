...
## 1. 通用规范
- **环境**: Py3.10.14; `trai_31014_whf_trai_pro_20260202`; UTF-8; 绝对导入; 类型注解; Google docstring.
...
## 2. 环境与依赖
- **命令**: `conda create -n trai_31014_whf_trai_pro_20260202 python=3.10.14 && conda activate trai_31014_whf_trai_pro_20260202`
